        ...
        <div className="grid gap-6 md:grid-cols-2">
          <Card className="p-6">
            ...
            <p className="mt-3 text-sm text-ink/70">
              We are a women-first platform dedicated to building ecosystems of
              opportunity, visibility, and growth for women leaders across
              India.
            </p>
          ...
          <Card className="p-6">
            ...
            <div className="mt-4 grid gap-4 sm:grid-cols-3">
              {[
                ...
                <div
                  key={item.label}
                  className="rounded-xl bg-mist/80 p-4 text-center"
                >
        ...
        <div className="mx-auto max-w-6xl px-6 py-16">
          ...
          <div className="grid gap-6 md:grid-cols-2">
            <Card className="p-6">
              ...
              <p className="mt-3 text-sm text-ink/70">
                We envision an India where women have equal opportunities,
            ...
            <Card className="p-6">
              ...
              <p className="mt-3 text-sm text-ink/70">
                We celebrate women's achievements, encourage innovation, and
                build strong networks that uplift communities and industries.
              </p>
            </Card>
          </div>
        </div>
      ...
      <section id="speakers" className="mx-auto max-w-6xl px-6 py-16 scroll-mt-24">
        ...
        <div className="grid gap-6 sm:grid-cols-2 lg:grid-cols-4">
          {topSpeakers.map((speaker) => (
            <Card key={speaker.id} className="overflow-hidden group">
              <img
                src={speaker.image}
                alt={speaker.name}
              ...
              />
              <div className="p-4">
                <h4 className="text-lg font-semibold text-ink group-hover:text-copper transition-colors">
                  {speaker.name}
                </h4>
        ...
        <div className="mx-auto max-w-6xl px-6 py-16">
          ...
          <div className="mt-10 grid gap-6 sm:grid-cols-2 lg:grid-cols-4">
            {featuredEvents.map((event) => (
              <Link to="/past-events" key={event.id} className="block group">
                <Card className="overflow-hidden transition-all hover:-translate-y-1 hover:shadow-soft">
                  ...
                  />
                  <div className="p-4">
                    <h4 className="text-base font-semibold text-ink group-hover:text-copper transition-colors line-clamp-2">
                      {event.title}
                    </h4>
        ...
        <div className="grid items-center gap-8 lg:grid-cols-[1.2fr_0.8fr]">
          <div>
            ...
            <p className="mt-4 text-sm text-ink/70">
              Nominate her for the SACHI Awards and help us celebrate
